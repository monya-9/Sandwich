			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				<div>
					...
					<div className="relative">
                        <input type="text" value={role} onChange={(e)=>setRole(e.target.value)} className="w-full h-[55px] py-0 leading-[55px] rounded-[10px] border border-[#E5E7EB] dark:border-[var(--border-color)] px-3 outline-none text-[14px] focus:border-[#068334] focus:ring-2 focus:ring-[#068334]/10 dark:bg-[var(--surface)] dark:text-white" placeholder="회사에서 담당한 역할을 입력해주세요." />
					</div>
				</div>
				<div>
                    <label className="block text-[13px] text-[#6B7280] dark:text-white/60 mb-2">회사 이름 <span className="text-green-500">*</span></label>
                    <input type="text" value={company} onChange={(e)=>setCompany(e.target.value)} className="w-full h-[55px] py-0 leading-[55px] rounded-[10px] border border-[#E5E7EB] dark:border-[var(--border-color)] px-3 outline-none text-[14px] focus:border-[#068334] focus:ring-2 focus:ring-[#068334]/10 dark:bg-[var(--surface)] dark:text-white" placeholder="회사 이름을 입력해주세요." />
				</div>
			</div>

			{/* 재직 기간 */}
			<div>
                <label className="block text-[13px] text-[#6B7280] dark:text-white/60 mb-2">재직 기간 <span className="text-green-500">*</span></label>
