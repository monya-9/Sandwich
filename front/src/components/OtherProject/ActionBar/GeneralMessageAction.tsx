    ...
    ? ReactDOM.createPortal(
        <>
          ...
          >
            ...
            {/* 내용 영역 */}
            <div className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex-1 overflow-visible" style={{ overscrollBehavior: "auto" }}>
              <div className="w-full sm:w-[400px] max-w-full mx-auto">
                <div className="text-center mb-2 sm:mb-3">
                  <div className="text-base sm:text-[18px] font-bold text-gray-800 dark:text-white">일반 메시지</div>
            ...
            <div className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 border-t border-gray-200 dark:border-[var(--border-color)] bg-white dark:bg-[var(--surface)] flex items-center justify-end gap-2 sm:gap-3">
              ...
              <button disabled={!canSubmit} onClick={submitForm as any} className={`px-4 sm:px-5 h-9 sm:h-10 rounded text-white text-sm sm:text-base ${canSubmit ? "bg-[#068334] hover:opacity-90" : "bg-gray-300 cursor-not-allowed"}`}>메시지 전송</button>
            </div>
          </div>
        </>,
        document.body
