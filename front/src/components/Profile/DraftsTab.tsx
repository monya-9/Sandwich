...
const DraftsTab: React.FC = () => {
    return (
        <div className="min-h-[360px] flex flex-col items-center justify-center text-center">
            <div className="mt-6 text-[16px] md:text-[18px] text-black/90 dark:text-white">작업 시작이 어렵고 막막하신가요?</div>
			...
			<div className="mt-6 flex items-center gap-3">
                ...
                <Link to="/project/sample" className="h-[44px] px-5 rounded-[22px] border border-black/20 dark:border-[var(--border-color)] text-[14px] flex items-center text-black dark:text-white bg-white dark:bg-[var(--surface)]">새로운 작업 업로드</Link>
			</div>
		</div>
	);
};
