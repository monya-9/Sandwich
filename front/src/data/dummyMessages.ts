...
export const dummyMessages: Message[] = [
    {
        id: 1,
        title: "환영합니다!",
        content: "Sandwich에 오신 것을 환영합니다. 궁금한 점이 있으면 언제든 메시지 주세요!",
    ...
    },
    {
        id: 6,
        title: "HR 문의",
        content: "안녕하세요, 채용 프로세스와 과제 전형 관련해 몇 가지 안내드립니다.",
    ...
    },
    {
        id: 7,
        title: "프로덕트 피드백 요청",
        content: "신규 온보딩 플로우를 만들고 있는데, UX 관점에서 간단히 피드백 부탁드려도 될까요?",
    ...
    },
    {
        id: 8,
        title: "클라우드 비용 알림",
        content: "이번 달 예상 비용이 임계치를 초과했습니다. 대시보드에서 확인 부탁드립니다.",
    ...
    },
    {
        id: 9,
        title: "리크루터 연락",
        content: "포지션이 오픈되어 연락드립니다. 커리어 관심 있으시면 짧게 통화 가능하실까요?",
    ...
    },
    {
        id: 10,
        title: "프로젝트 킥오프",
        content: "이번 주 금요일 14시에 킥오프 미팅 예정입니다. 안건 정리해서 공유드릴게요.",
