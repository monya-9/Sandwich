// src/pages/OtherProjectPage.tsx
...
export default function OtherProjectPage() {
    ...
    const { ownerId: ownerIdParam, projectId: projectIdParam } = useParams<{
        ownerId?: string;
        projectId?: string;
    }>();
    ...
    useEffect(() => {
        if (ownerId && projectId) {
            fetchProjectDetail(ownerId, projectId)
